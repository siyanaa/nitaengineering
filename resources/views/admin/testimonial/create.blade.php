...
@section('content')
    ...
    <!-- Content Header (Page header) -->
            ...
            <form id="quickForm" method="POST" action="{{ route('admin.testimonial.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <!--</div>-->
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="position" class="form-control" placeholder="Title" required>
                    </div>
                    <br>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn-primary">Create testimonial Page</button>
                </div>
            </form>
