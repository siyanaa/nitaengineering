...
@section('content')
    ...
    <!-- Content Header (Page header) -->
            ...
            <form id="quickForm" method="POST" action="{{ route('admin.project.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Image</label><span style="color:red; font-size:large"> *</span>
                    ...
                    <div class="form-group">
                        ...
                        <label for="contact_number">PDF</label>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn-primary">Create Project Page</button>
                </div>
            </form>
