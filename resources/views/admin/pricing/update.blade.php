...
@section('content')
    ...
    <form id="quickForm" method="POST" action="{{ route('admin.pricing.update') }}" enctype="multipart/form-data">
        @csrf
        <input type="" name="id" value="{{ $pricing->id }}" hidden>
        <div class="card-body">
            <div class="form-group">
                <label for="title">Title</label>
                <input type="text" name="title" class="form-control" placeholder="Title.." value="{{ $pricing->title }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" name="image" class="form-control" id="image" onchange="previewImage(event)"
                    placeholder="Image">
                <img id="preview1" src="{{ url('uploads/news/image' . $pricing->image) }}"
