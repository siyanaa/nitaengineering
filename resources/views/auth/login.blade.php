              ...
              <div class="col-md-7 d-flex flex-center">
                <div class="p-4 p-md-5 flex-grow-1">
                  ...
                  <form method="post" action="{{ url('login') }}">
                    ...
                    <input class="form-control" id="card-password" type="password" name="password" value="{{ old('password')}}">
                    ...
                    <div class="row flex-between-center">
                      <div class="col-auto">
                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox" id="card-checkbox" checked="checked" name="remember">
